package com.example.archunit.compose;
...
public class ArchUnitComposeTest {
    ...
    @ArchTest
    CompositeArchRule archRule = CompositeArchRule.of(codeUnits_should_declare_all_RuntimeExceptions_they_throw)
            .and(codeUnits_should_declare_all_RuntimeExceptions_of_methods_they_call);


    private List<ArchRule> ruleList = List.of(codeUnits_should_declare_all_RuntimeExceptions_they_throw,
            codeUnits_should_declare_all_RuntimeExceptions_of_methods_they_call);

    @ArchTest
    CompositeArchRule compositeArchRule = CompositeArchRule.of(ruleList);
